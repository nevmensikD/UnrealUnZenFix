...
namespace UnrealUnZen
{
    public partial class MainTool : Form
    {
        ...
        private void UTocVerCMB_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        {
            string message = "RU: Если при упаковке приложение зависнет, то это нормально. Не закрывайте приложение во время упаковки.\n\n" +
                            "ENG: If the application freezes during packaging, it is normal. Do not close the application during packaging.";
            MessageBox.Show(message, "Packaging Information", MessageBoxButtons.OK);
        }
    }
}
